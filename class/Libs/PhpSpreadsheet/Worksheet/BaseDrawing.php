...
use PhpSpreadsheet\IComparable;
...
class BaseDrawing implements IComparable
{
    ...
    public function setWorksheet(Worksheet $pValue = null, $pOverrideOld = false)
    {
        if ($this->worksheet === null) {
            // Add drawing to \PhpSpreadsheet\Worksheet\Worksheet
            $this->worksheet = $pValue;
            $this->worksheet->getCell($this->coordinates);
            $this->worksheet->getDrawingCollection()->append($this);
        } else {
            if ($pOverrideOld) {
                // Remove drawing from old \PhpSpreadsheet\Worksheet\Worksheet
                ...
                // Set new \PhpSpreadsheet\Worksheet\Worksheet
                $this->setWorksheet($pValue);
            } else {
                throw new PhpSpreadsheetException('A Worksheet has already been assigned. Drawings can only exist on one \\\PhpSpreadsheet\\Worksheet.');
            }
        }
