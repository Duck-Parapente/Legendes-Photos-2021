...
class Drawing extends WriterPart
{
     ...
     */
    public function writeDrawings(\PhpSpreadsheet\Worksheet\Worksheet $pWorksheet, $includeCharts = false)
    {
        // Create XML writer
        $objWriter = null;
     ...
     */
    public function writeChart(XMLWriter $objWriter, \PhpSpreadsheet\Chart\Chart $pChart, $pRelationId = -1)
    {
     ...
     * @return string XML Output
     */
    public function writeVMLHeaderFooterImages(\PhpSpreadsheet\Worksheet\Worksheet $pWorksheet)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
