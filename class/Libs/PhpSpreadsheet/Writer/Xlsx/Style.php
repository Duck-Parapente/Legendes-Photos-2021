...
class Style extends WriterPart
{
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \PhpSpreadsheet\Style\Style $pStyle Style
     * @param Spreadsheet $spreadsheet Workbook
     *
     * @throws \PhpSpreadsheet\Writer\Exception
     */
    private function writeCellStyleXf(XMLWriter $objWriter, \PhpSpreadsheet\Style\Style $pStyle, Spreadsheet $spreadsheet)
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', 0);
     ...
     * @param \PhpSpreadsheet\Style\Style $pStyle Style
     */
    private function writeCellStyleDxf(XMLWriter $objWriter, \PhpSpreadsheet\Style\Style $pStyle)
    {
        // dxf
     ...
     * @param Spreadsheet $spreadsheet
     *
     * @return \PhpSpreadsheet\Style\Style[] All styles in PhpSpreadsheet
     */
    ...
    public function allFills(Spreadsheet $spreadsheet)
    {
        ...
        /** @var \PhpSpreadsheet\Style\Style $style */
