...
use PhpSpreadsheet\Chart\Axis;
use PhpSpreadsheet\Chart\DataSeries;
use PhpSpreadsheet\Chart\DataSeriesValues;
use PhpSpreadsheet\Chart\GridLines;
use PhpSpreadsheet\Chart\Layout;
use PhpSpreadsheet\Chart\Legend;
use PhpSpreadsheet\Chart\PlotArea;
use PhpSpreadsheet\Chart\Title;
...
class Chart extends WriterPart
{
     ...
     *
     * @param \PhpSpreadsheet\Chart\Chart $pChart
     ...
     */
    public function writeChart(\PhpSpreadsheet\Chart\Chart $pChart, $calculateCellValues = true)
    {
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \PhpSpreadsheet\Worksheet\Worksheet $pSheet
     ...
     * @throws WriterException
     */
    private function writePlotArea(XMLWriter $objWriter, \PhpSpreadsheet\Worksheet\Worksheet $pSheet, PlotArea $plotArea, Title $xAxisLabel = null, Title $yAxisLabel = null, Axis $xAxis = null, Axis $yAxis = null, GridLines $majorGridlines = null, GridLines $minorGridlines = null)
    {
        if ($plotArea === null) {
            return;
        }
