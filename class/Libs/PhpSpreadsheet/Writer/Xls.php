...
use PhpSpreadsheet\Cell\Coordinate;
use PhpSpreadsheet\RichText\RichText;
use PhpSpreadsheet\RichText\Run;
use PhpSpreadsheet\Shared\Drawing as SharedDrawing;
use PhpSpreadsheet\Shared\Escher;
use PhpSpreadsheet\Shared\Escher\DgContainer;
use PhpSpreadsheet\Shared\Escher\DgContainer\SpgrContainer;
use PhpSpreadsheet\Shared\Escher\DgContainer\SpgrContainer\SpContainer;
use PhpSpreadsheet\Shared\Escher\DggContainer;
use PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer;
use PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE;
use PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE\Blip;
use PhpSpreadsheet\Shared\OLE;
use PhpSpreadsheet\Shared\OLE\PPS\File;
use PhpSpreadsheet\Shared\OLE\PPS\Root;
use PhpSpreadsheet\Spreadsheet;
use PhpSpreadsheet\Worksheet\BaseDrawing;
use PhpSpreadsheet\Worksheet\Drawing;
use PhpSpreadsheet\Worksheet\MemoryDrawing;
...
class Xls extends BaseWriter
{
     ...
     * Formula parser.
     *
     * @var \PhpSpreadsheet\Writer\Xls\Parser
     */
    private $parser;
    ...
    /**
     * @var \PhpSpreadsheet\Writer\Xls\Workbook
     */
    private $writerWorkbook;

    /**
     * @var \PhpSpreadsheet\Writer\Xls\Worksheet[]
     */
    ...
    private function buildWorksheetEschers()
    {
        ...
        foreach ($this->spreadsheet->getAllsheets() as $sheet) {
            ...
            foreach ($sheet->getDrawingCollection() as $drawing) {
                ...
                $twoAnchor = \PhpSpreadsheet\Shared\Xls::oneAnchor2twoAnchor($sheet, $coordinates, $offsetX, $offsetY, $width, $height);
