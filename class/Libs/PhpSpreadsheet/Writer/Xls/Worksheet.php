...
namespace PhpSpreadsheet\Writer\Xls;
...
class Worksheet extends BIFFwriter
{
     ...
     * @param \PhpSpreadsheet\Worksheet\Worksheet $phpSheet The worksheet to write
     */
    public function __construct(&$str_total, &$str_unique, &$str_table, &$colors, Parser $parser, $preCalculateFormulas, \PhpSpreadsheet\Worksheet\Worksheet $phpSheet)
    {
...
//        if ($this->firstColumnIndex > 255) $this->firstColumnIndex = 255;
     ...
     *
     * @see \PhpSpreadsheet\Writer\Xls\Workbook::storeWorkbook()
     */
    ...
    private function writeBreaks()
    {
        ...
        foreach ($this->phpSheet->getBreaks() as $cell => $breakType) {
            ...
            switch ($breakType) {
                case \PhpSpreadsheet\Worksheet\Worksheet::BREAK_COLUMN:
                    // Add to list of vertical breaks
                    $vbreaks[] = Coordinate::columnIndexFromString($coordinates[0]) - 1;

                    break;
                case \PhpSpreadsheet\Worksheet\Worksheet::BREAK_ROW:
                    // Add to list of horizontal breaks
                    $hbreaks[] = $coordinates[1];

                    break;
                case \PhpSpreadsheet\Worksheet\Worksheet::BREAK_NONE:
                default:
                    // Nothing to do
                    break;
            }
