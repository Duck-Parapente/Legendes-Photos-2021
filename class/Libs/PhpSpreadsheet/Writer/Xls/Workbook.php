...
class Workbook extends BIFFwriter
{
     ...
     * XF Writers.
     *
     * @var \PhpSpreadsheet\Writer\Xls\Xf[]
     */
    private $xfWriters = [];
    ...
    private function writeBoundSheet($sheet, $offset)
    {
        ...
        switch ($sheet->getSheetState()) {
            case \PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VISIBLE:
                $ss = 0x00;

                break;
            case \PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_HIDDEN:
                $ss = 0x01;

                break;
            case \PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN:
                $ss = 0x02;
