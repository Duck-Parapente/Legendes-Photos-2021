...
namespace PhpSpreadsheet\Reader\Xlsx;
...
class Chart
{
     ...
     *
     * @return \PhpSpreadsheet\Chart\Chart
     */
    public static function readChart(SimpleXMLElement $chartElements, $chartName)
    {
        ...
        $chart = new \PhpSpreadsheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, $dispBlanksAs, $XaxisLabel, $YaxisLabel);
