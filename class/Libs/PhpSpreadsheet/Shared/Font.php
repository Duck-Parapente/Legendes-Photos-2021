...
class Font
{
     ...
     * @param null|\PhpSpreadsheet\Style\Font $defaultFont Font object
     *
     ...
     */
    public static function getTextWidthPixelsApprox($columnText, \PhpSpreadsheet\Style\Font $font, $rotation = 0)
    {
